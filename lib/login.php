	...
	<div id="main-wrapper">
		<div id="login-wrapper">
			<form method="post" action="">
				...
				<button type="submit" name="login" value="Log me in" style="display:inline">Log me in</button> 
				<button type="button" name="register" value="Register" onclick="location.href='registerpage.php'" style="display:inline">Register</button>
			</form>
