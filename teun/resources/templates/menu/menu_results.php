...
<center>
	<ul class="sonarmenu">
		<li><a href="" style="font-size: small">Show my results</a></li>
		<li><a href="" style="font-size: small">Show all results</a></li>
		<li>
			<ul class="sonarmenu">
				<li style="margin: 0px 0px 0px 20px">Filter by:</li>
				<li><a href="" style="font-size: small; margin: 10px 2px">topic</a></li>
				<li><a href="" style="font-size: small; margin: 10px 2px">label</a></li>
				<li><a href="" style="font-size: small; margin: 10px 2px">user</a></li>
				<li><a href="" style="font-size: small; margin: 10px 2px">test</a></li>
			</ul>
		</li>
	</ul>
</center>
