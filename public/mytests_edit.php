...
// 			Test name and owner are saved. Now save which questionids belong to testid.
	...
	if (isset($_POST['edit']))
	{
		...
		<form action=<?php echo htmlspecialchars('mytests_edit.php');?> method="post">
			<input type="text" name="question" value='<?php echo $_SESSION['questions']->1; ?>' placeholder="Question <?php echo $_SESSION['questionno']?>" style="display:inline; width:70%; font-weight:bold">
