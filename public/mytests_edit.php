...
{ ?>
	...
	?>		
		...
		<form action=<?php echo htmlspecialchars('mytests_edit.php');?> method="post">
		Test Name<br>
		<input type="text" name="testname" value="Give your test a name." onfocus="if(this.value==this.defaultValue)this.value='';" onblur="if(this.value=='')this.value=this.defaultValue;"><br>
