...
{ ?>
	...
	?>		
		...
		<button type="submit" name="action" value="save" style="width:6em; height:2em; margin:0 0 0 0; padding:0 0 0 0; border: 0 0 0 0;">Save</button>
		<button type="submit" name="action" value="deleteall" style="width:6em; height:2em; margin:0 0 0 0; padding:0 0 0 0; border: 0 0 0 0;">Delete</button>
		</form>
		<br>
		<br>
